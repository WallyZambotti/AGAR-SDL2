...
#define AG_DRIVER_TEXTURES	0x04		/* Support texture ops */
	...
	void (*uploadTexture)(void *drv, void *, AG_Surface *, AG_TexCoord *); // WDZ - Texture
	int  (*updateTexture)(void *drv, void *, AG_Surface *, AG_TexCoord *); // WDZ - Texture
	void (*deleteTexture)(void *drv, void *); // WDZ - Texture
