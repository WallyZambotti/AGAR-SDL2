...
void AG_GL_StdUploadTexture(void *, void *, AG_Surface *, AG_TexCoord *); // WDZ - Textures
int  AG_GL_StdUpdateTexture(void *, void *, AG_Surface *, AG_TexCoord *); // WDZ - Textures
void AG_GL_StdDeleteTexture(void *, void *); // WDZ - Textures
...
AG_GL_UploadTexture(void *obj, void *name, AG_Surface *su, AG_TexCoord *tc) // WDZ - Textures
{
	AG_Driver *drv = obj;
...
AG_GL_UpdateTexture(void *obj, void *name, AG_Surface *su, AG_TexCoord *tc) // WDZ - Textures
{
	AG_Driver *drv = obj;
	AG_DriverClass *dc = AGDRIVER_CLASS(drv);
...
static __inline__ void
AG_GL_DeleteTexture(void *obj, void *name) // WDZ - Textures
{
	AG_Driver *drv = obj;
	AG_DriverClass *dc = AGDRIVER_CLASS(drv);
